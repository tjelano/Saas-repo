...
import { FaBed, FaCouch, FaTree, FaRestroom, FaTshirt } from 'react-icons/fa';
...
const InteractiveSelector = () => {
  ...
  const options = [
    {
      title: "Modern",
      description: "Sleek, clean, and minimalist",
      image: "https://images.unsplash.com/photo-1554995207-c18c203602cb?auto=format&fit=crop&w=800&q=80",
      icon: <FaCouch size={24} className="text-white" />
    },
    {
      title: "Scandinavian",
      description: "Light, airy, and functional",
      image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=800&q=80",
      icon: <FaBed size={24} className="text-white" />
    },
    {
      title: "Bohemian",
      description: "Eclectic, vibrant, and free-spirited",
      image: "https://images.unsplash.com/photo-1543489822-c5521da42163?auto=format&fit=crop&w=800&q=80",
      icon: <FaTshirt size={24} className="text-white" />
    },
    {
      title: "Industrial",
      description: "Raw, edgy, and unfinished",
      image: "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?auto=format&fit=crop&w=800&q=80",
      icon: <FaRestroom size={24} className="text-white" />
    },
    {
      title: "Biophilic",
  ...
  return (
    <div id="gallery" className="relative flex flex-col items-center justify-center min-h-screen bg-[#222] font-sans text-white"> 
      {/* Header Section */}
      <div className="w-full max-w-2xl px-6 mt-8 mb-2 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-3 tracking-tight drop-shadow-lg animate-fadeInTop delay-300">Explore Design Styles</h1>
        <p className="text-lg md:text-xl text-gray-300 font-medium max-w-xl mx-auto animate-fadeInTop delay-600">Discover a world of interior design possibilities. Click on any style to see a larger preview.</p>
      </div>
